...
void dibujarInterfaz(int** tablero, Pieza piezaActual, Pieza piezaSiguiente, int fila, int columna, char nombre[], int longitud, int puntaje, double tiempocaida, int paleta_tipo, int ancho_ventana, int alto_ventana);
